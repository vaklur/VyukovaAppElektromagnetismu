...
/* fragment, than visualised Dipole radiation in E and Cartesian coordinate system*/
public class DipolEKartez extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.dipol_e_kartez, container, false);
        ...
        double pi=Math.PI;
        double k=(2*pi*f)/c;
        double [] FE = new double[181];
        int i;

        LineChart linechart = (LineChart) view.findViewById(R.id.EKartezLCH);
        ...
        for (double th =-90 ; th < 91; th++) {
            ...
            FE[i]=FE[i]/maxfe;
            String tfe = Double.toString(FE[i]);
            float y = Float.parseFloat(tfe);
